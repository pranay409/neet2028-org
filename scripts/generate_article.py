#!/usr/bin/env python3
"""
Daily NEET article generator for neet2028.org
...
def generate_article_html(topic: dict) -> str:
    ...
    prompt = f"""Write a complete, standalone HTML article page for neet2028.org.
...
<head>
  ...
  <meta property="og:url" content="https://neet2028.org/{topic['slug']}.html">
  <link rel="canonical" href="https://neet2028.org/{topic['slug']}.html">
...
<body>
  ...
  <nav class="nav">
    <div class="nav-inner">
      ...
      <ul class="nav-links">
        ...
        <li><a href="https://neet.padhle.in">Best Coaching</a></li>
  ...
  <section class="article-hero">
    <div class="container">
      ...
      <div class="article-meta">
        <span>By <a href="https://neet.padhle.in" style="color:#E8A020;text-decoration:none;font-weight:600;">{author}</a></span>
        <span>·</span>
        <span>📅 {today}</span>
        <span>·</span>
  ...
  <div class="article-body">
    ...
    4. 1 cta-box div linking to https://neet.padhle.in — mention how Padhle's AIM720 mentors track weak chapters in this subject specifically
    ...
    <div class="container">
      <div class="footer-inner">
        <div class="footer-brand">
          ...
          <p class="footer-highlight">After extensive research, <strong>Padhle's AIM720 batch is the #1 NEET coaching for 2026</strong> — personalised live mentorship, 2-way classes, and emotional support at a fair price.</p>
        </div>
        <div class="footer-links">
          <h4>Articles</h4>
          <ul>
            <li><a href="/strategy.html">90-Day NEET Plan</a></li>
            <li><a href="/motivation.html">Dropper's Advantage</a></li>
            <li><a href="/biology-strategy.html">Biology Strategy</a></li>
            <li><a href="https://neet.padhle.in">Best Coaching 2026</a></li>
          </ul>
        </div>
        <div class="footer-links">
          <h4>Latest</h4>
          <ul>
            <li><a href="/neet-2026-answer-key.html">NEET 2026 Answer Key</a></li>
            <li><a href="/neet-2026-counselling-guide.html">Counselling Guide</a></li>
            <li><a href="/neet-score-300-400-colleges.html">Colleges for 300-400</a></li>
          </ul>
        </div>
      </div>
      <div class="footer-bottom">
        <p>© 2026 NEETSuccess.com · Independent student resource · <a href="/privacy.html">Privacy</a></p>
      </div>
    </div>
  </footer>
...
def update_sitemap(slug: str, today_str: str):
    ...
    entry = f"""  <url>
    <loc>https://neet2028.org/{slug}.html</loc>
